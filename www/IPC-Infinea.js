...
var Infinea = {
    ...
    */
    ...
    {
        cordova.exec(null, null, 'Infinea', 'initWithCallbacks', [ { barcodeStatusCallback: "Infinea._onBarcodeStatus", barcodeDataCallback: "Infinea._onBarcodeData", buttonPressedCallback: "Infinea._onButtonPressed", bluetoothStatusCallback: "Infinea._onBluetoothStatus" } ]);
    },
    ...
    _onBluetoothStatus: function(status)
    {
        if(this.bluetoothStatusCallback !=null)
            this.bluetoothStatusCallback(status);
    },
